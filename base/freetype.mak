...
ft_autofit=$(FTOBJ)afangles.$(OBJ)  $(FTOBJ)afcjk.$(OBJ)  $(FTOBJ)afdummy.$(OBJ)  $(FTOBJ)afglobal.$(OBJ)  $(FTOBJ)afhints.$(OBJ)  $(FTOBJ)afindic.$(OBJ)  $(FTOBJ)aflatin.$(OBJ)  $(FTOBJ)afloader.$(OBJ)  $(FTOBJ)afmodule.$(OBJ)  $(FTOBJ)afwarp.$(OBJ)

ft_base=$(FTOBJ)ftadvanc.$(OBJ)  $(FTOBJ)ftcalc.$(OBJ)  $(FTOBJ)ftdbgmem.$(OBJ)  $(FTOBJ)ftgloadr.$(OBJ)  $(FTOBJ)ftobjs.$(OBJ)  $(FTOBJ)ftoutln.$(OBJ)  $(FTOBJ)ftrfork.$(OBJ)  $(FTOBJ)ftsnames.$(OBJ)  $(FTOBJ)ftstream.$(OBJ)  $(FTOBJ)fttrigon.$(OBJ)  $(FTOBJ)ftutil.$(OBJ)  $(FTOBJ)ftbbox.$(OBJ)  $(FTOBJ)ftbdf.$(OBJ)  $(FTOBJ)ftbitmap.$(OBJ)  $(FTOBJ)ftdebug.$(OBJ)  $(FTOBJ)ftgasp.$(OBJ)  $(FTOBJ)ftglyph.$(OBJ)  $(FTOBJ)ftgxval.$(OBJ)  $(FTOBJ)ftinit.$(OBJ)  $(FTOBJ)ftlcdfil.$(OBJ)  $(FTOBJ)ftmm.$(OBJ)  $(FTOBJ)ftotval.$(OBJ)  $(FTOBJ)ftpfr.$(OBJ)  $(FTOBJ)ftstroke.$(OBJ)  $(FTOBJ)ftsynth.$(OBJ)  $(FTOBJ)ftsystem.$(OBJ)  $(FTOBJ)fttype1.$(OBJ)  $(FTOBJ)ftwinfnt.$(OBJ)  $(FTOBJ)ftxf86.$(OBJ)  $(FTOBJ)ftpatent.$(OBJ)

ft_bdf=$(FTOBJ)bdflib.$(OBJ)  $(FTOBJ)bdfdrivr.$(OBJ)

ft_cache=$(FTOBJ)ftcbasic.$(OBJ)  $(FTOBJ)ft2ccache.$(OBJ)  $(FTOBJ)ftccmap.$(OBJ)  $(FTOBJ)ftcglyph.$(OBJ)  $(FTOBJ)ftcimage.$(OBJ)  $(FTOBJ)ftcmanag.$(OBJ)  $(FTOBJ)ftcmru.$(OBJ)  $(FTOBJ)ftcsbits.$(OBJ)

ft_cff=$(FTOBJ)cffobjs.$(OBJ)  $(FTOBJ)cffload.$(OBJ)  $(FTOBJ)cffgload.$(OBJ)  $(FTOBJ)cffparse.$(OBJ)  $(FTOBJ)cffcmap.$(OBJ)  $(FTOBJ)cffdrivr.$(OBJ)

ft_cid=$(FTOBJ)cidparse.$(OBJ)  $(FTOBJ)cidload.$(OBJ)  $(FTOBJ)cidriver.$(OBJ)  $(FTOBJ)cidgload.$(OBJ)  $(FTOBJ)cidobjs.$(OBJ)

ft_gzip=$(FTOBJ)ftgzip.$(OBJ)

ft_lzw=$(FTOBJ)ftlzw.$(OBJ)

ft_pcf=$(FTOBJ)pcfdrivr.$(OBJ)  $(FTOBJ)pcfread.$(OBJ)  $(FTOBJ)pcfutil.$(OBJ)

ft_pfr=$(FTOBJ)pfrload.$(OBJ)  $(FTOBJ)pfrgload.$(OBJ)  $(FTOBJ)pfrcmap.$(OBJ)  $(FTOBJ)pfrdrivr.$(OBJ)  $(FTOBJ)pfrsbit.$(OBJ)  $(FTOBJ)pfrobjs.$(OBJ)

ft_psaux=$(FTOBJ)psobjs.$(OBJ)  $(FTOBJ)t1decode.$(OBJ)  $(FTOBJ)t1cmap.$(OBJ)  $(FTOBJ)afmparse.$(OBJ)  $(FTOBJ)psconv.$(OBJ)  $(FTOBJ)psauxmod.$(OBJ)

ft_pshinter=$(FTOBJ)pshrec.$(OBJ)  $(FTOBJ)pshglob.$(OBJ)  $(FTOBJ)pshmod.$(OBJ)  $(FTOBJ)pshalgo.$(OBJ)

ft_psnames=$(FTOBJ)psmodule.$(OBJ)  $(FTOBJ)pspic.$(OBJ)

ft_raster=$(FTOBJ)ftraster.$(OBJ)  $(FTOBJ)ftrend1.$(OBJ)  $(FTOBJ)rastpic.$(OBJ)

ft_smooth=$(FTOBJ)ftgrays.$(OBJ)  $(FTOBJ)ftsmooth.$(OBJ)  $(FTOBJ)ftspic.$(OBJ)

ft_sfnt=$(FTOBJ)sfobjs.$(OBJ)  $(FTOBJ)sfdriver.$(OBJ)  $(FTOBJ)ttcmap.$(OBJ)  $(FTOBJ)ttmtx.$(OBJ)  $(FTOBJ)ttpost.$(OBJ)  $(FTOBJ)ft2ttload.$(OBJ)  $(FTOBJ)ttsbit.$(OBJ)  $(FTOBJ)ttkern.$(OBJ)  $(FTOBJ)ttbdf.$(OBJ)  $(FTOBJ)sfntpic.$(OBJ)

ft_truetype=$(FTOBJ)ttdriver.$(OBJ)  $(FTOBJ)ft2ttobjs.$(OBJ)  $(FTOBJ)ttpload.$(OBJ)  $(FTOBJ)ttgload.$(OBJ)  $(FTOBJ)ft2ttinterp.$(OBJ)  $(FTOBJ)ttgxvar.$(OBJ)  $(FTOBJ)ttpic.$(OBJ)

ft_type1=$(FTOBJ)t1afm.$(OBJ)  $(FTOBJ)t1driver.$(OBJ)  $(FTOBJ)t1objs.$(OBJ)  $(FTOBJ)t1load.$(OBJ)  $(FTOBJ)t1gload.$(OBJ)  $(FTOBJ)t1parse.$(OBJ)

ft_type42=$(FTOBJ)t42objs.$(OBJ)  $(FTOBJ)t42parse.$(OBJ)  $(FTOBJ)t42drivr.$(OBJ)
