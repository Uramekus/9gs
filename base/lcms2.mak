...
lcms2_OBJS=$(LCMS2OBJ)cmscam02.$(OBJ) $(LCMS2OBJ)cmscgats.$(OBJ) $(LCMS2OBJ)cmscnvrt.$(OBJ) $(LCMS2OBJ)cmserr.$(OBJ) $(LCMS2OBJ)cmsgamma.$(OBJ) $(LCMS2OBJ)cmsgmt.$(OBJ) $(LCMS2OBJ)cmsintrp.$(OBJ) $(LCMS2OBJ)cmsio0.$(OBJ) $(LCMS2OBJ)cmsio1.$(OBJ) $(LCMS2OBJ)cmslut.$(OBJ) $(LCMS2OBJ)cmsmd5.$(OBJ) $(LCMS2OBJ)cmsmtrx.$(OBJ) $(LCMS2OBJ)cmsnamed.$(OBJ) $(LCMS2OBJ)cmsopt.$(OBJ) $(LCMS2OBJ)cmspack.$(OBJ) $(LCMS2OBJ)cmspcs.$(OBJ) $(LCMS2OBJ)cmsplugin.$(OBJ) $(LCMS2OBJ)cmsps2.$(OBJ) $(LCMS2OBJ)cmssamp.$(OBJ) $(LCMS2OBJ)cmstypes.$(OBJ) $(LCMS2OBJ)cmsvirt.$(OBJ) $(LCMS2OBJ)cmswtpnt.$(OBJ) $(LCMS2OBJ)cmsxform.$(OBJ)
